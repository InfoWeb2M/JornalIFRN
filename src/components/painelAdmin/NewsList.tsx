...
import { Copy, Edit, List as ListIcon, Loader2, Trash2 } from "lucide-react";
...
const NewsList = () => {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            ...
            toastSuccess("A notícia foi deletada com sucesso");
        } catch (error) {
            toastError(error instanceof Error ? error.message : "Tente novamente");
        }
    };
        ...
        <>
            ...
            >
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-foreground">Notícias ({news.length})</h2>
                </div>
                        ...
                        >
                            <div className="flex flex-col md:flex-row gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-muted-foreground text-sm mb-2 line-clamp-2">{item.summary}</p>
