...
<html lang="pt-BR">
  ...
  <body>
    ...
    <header class="container">
      ...
      <nav class="sidebar" id="sidebar">
        ...
        <section id="tema">
          ...
          >
            <label style="color: var(--text)" for="botao-tema">tema:</label>
            <svg class="icone-tema" viewBox="0 0 24 24" fill="none">
              <path id="icone" d="" />
            </svg>
          </button>
        </section>
    ...
    <footer style="gap: 1.5rem" class="container">
      <!-- INSTAGRAM -->
      <a href="https://www.instagram.com/jornal_teresa/">
        <svg
          class="icon"
          role="img"
        ...
        >
          <path
            d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7A5 5 0 0 1 7 2zm5 5.5A4.5 4.5 0 1 0 16.5 12 4.5 4.5 0 0 0 12 7.5zm5.5-1.75a1.25 1.25 0 1 1-1.25 1.25 1.25 1.25 0 0 1 1.25-1.25zM12 9a3 3 0 1 1-3 3 3 3 0 0 1 3-3z"
          />
        </svg>
      </a>
      <!-- GITHUB -->
